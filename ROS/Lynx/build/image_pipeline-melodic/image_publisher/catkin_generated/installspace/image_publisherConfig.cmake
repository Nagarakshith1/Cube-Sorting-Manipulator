...
if("FALSE" STREQUAL "TRUE")
  set(image_publisher_SOURCE_PREFIX /home/ms/Lynx/src/image_pipeline-melodic/image_publisher)
  set(image_publisher_DEVEL_PREFIX /home/ms/Lynx/devel)
  ...
  set(image_publisher_INSTALL_PREFIX /home/ms/Lynx/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>, Steven Macenski <stevenmacenski@gmail.com>, Autonomoustuff team <software@autonomoustuff.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ms/Lynx/install/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>, Steven Macenski <stevenmacenski@gmail.com>, Autonomoustuff team <software@autonomoustuff.com>' to fix it.")
    endif()
