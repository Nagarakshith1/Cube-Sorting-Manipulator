...
if("FALSE" STREQUAL "TRUE")
  set(realsense2_description_SOURCE_PREFIX /home/ms/Lynx/src/realsense-ros-development/realsense2_description)
  set(realsense2_description_DEVEL_PREFIX /home/ms/Lynx/devel)
  ...
  set(realsense2_description_INSTALL_PREFIX /home/ms/Lynx/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'realsense2_description' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Sergey Dorodnicov <sergey.dorodnicov@intel.com>, Doron Hirshberg <doron.hirshberg@intel.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'realsense2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ms/Lynx/install/${idir}'.  Ask the maintainer 'Sergey Dorodnicov <sergey.dorodnicov@intel.com>, Doron Hirshberg <doron.hirshberg@intel.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${realsense2_description_dep}_FOUND)
      find_package(${realsense2_description_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${realsense2_description_dep} REQUIRED ${depend_list})
  endif()
